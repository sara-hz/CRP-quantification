---
title: "CRP_quantification_29.09.2022"
author: "Sara.H, Yousra.H"
date: "09/29/2022"
...
```{r }
CRPDataOrigFn <- "~/Desktop/CRP kwant/KS-CRP-measurements-20220929.csv"
CRPDataParsedFn <- "~/Desktop/CRP kwant/KS-CRP_tidied_complete.csv"
CRPDataDistLongFn <- "~/Desktop/CRP kwant/KS-CRP_org_by_region.csv"
```
...
```{r }
# Rename one file_name 
CRPData <- CRPData %>% mutate(file_name = str_replace(file_name, "(R3b-CRP)", "R3b_CRP"))
